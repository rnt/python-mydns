...
"""
 ...
 Based on Milan Nikolic <gen2brain@gmail.com> works.
...
NOTE: if passwd is None, we try to connect without password. Although it may seem an idiocy, mysql allows users without password.
        """
        try:
            self._host = host
            self._dbname = db
